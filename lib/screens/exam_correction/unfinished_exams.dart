...
class UnFinishedExams extends StatefulWidget {
  const UnFinishedExams({Key? key}) : super(key: key);

  @override
  State<UnFinishedExams> createState() => _UnFinishedExamsState();
}

class _UnFinishedExamsState extends State<UnFinishedExams> {
  int selectedLevel = 0;
